...
@section('title', 'Primrica Global Capital Market Hub - Invest, Trade Stocks & Buy Premium Primrica Global Capital
Vehicles')
@section('meta_title', 'Primrica Global Capital Market Hub - Invest, Trade Stocks & Buy Premium Vehicles')
@section('meta_description', 'Invest in automated plans with daily returns, trade stocks in real-time, and purchase
premium Primrica Global Capital vehicles. Your all-in-one platform for wealth building and luxury electric cars.')
@section('meta_keywords', 'Primrica Global Capital investment, stock trading, Primrica Global Capital vehicles,
automated investing, wealth building, Primrica Global Capital cars, stock market, investment plans, electric vehicles,
Primrica Global Capital model s, model 3, model x, model y')

@section('og_title', 'Primrica Global Capital Market Hub - Invest, Trade & Drive Electric')
@section('og_description', 'Your all-in-one platform for automated investments, real-time stock trading, and premium
Primrica Global Capital vehicle purchases.')
...
<section class="hero">
    <div class="wrap heroInner">
        <div class="grid grid-cols-12 gap-6 items-start">
            ...
            <div class="col-span-12 lg:col-span-7">
                ...
                <p class="lead">
                    All-in-one platform for crypto wallet funding, automated investments, <span
                        class="text-[#E31937] font-[700]">live stocks</span>, and premium
                    EV inventory.
                </p>
                ...
                <div class="btnRow">
                    ...
                    <a href="{{ route('dashboard.investments') }}" class="btn primary"
                        style="background: #E31937; border-color: #E31937;">
                        @else
                        ...
                        <a href="{{ route('stocks') }}"
                            class="btn outline hover:border-[#E31937] hover:text-[#E31937] transition-colors">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M4 19V5" />
                                <path d="M4 19h16" />
            ...
            <div class="col-span-12 lg:col-span-5">
                <div class="glass p-4 rounded-[18px] border border-[#E31937]/20">
                    <!-- Elon Musk Video -->
                    <div class="relative w-full rounded-[12px] overflow-hidden mb-4 ring-2 ring-[#E31937]/30"
                    ...
                    <div class="text-white/90">
                        <h3 class="text-[20px] font-[900] mb-3 text-white">Vision for the Future <span
                                class="text-[#E31937]">•</span></h3>
                        <p class="text-[14px] leading-relaxed text-white/80">
                            ...
                            we're not just building electric vehicles—we're creating a sustainable energy ecosystem that
                            will
                            transform how we power our world. Every Primrica Global Capital vehicle, every solar panel,
                            every battery we produce
    ...
    <div class="wrap pt-20 pb-6">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            <!-- Wallet -->
            <div
                class="glass soft p-6 flex items-center justify-between min-h-[86px] hover:border-[#E31937]/30 transition-colors">
                <div>
...
<!-- Primrica Global Capital Investment Plans section -->
<section class="bg-[#07090c] border-t border-[#E31937]/20">
    <div class="wrap py-14">
        <div class="flex items-start justify-between gap-6 mb-6">
            <div>
                <h2 class="text-[26px] md:text-[32px] font-[900] tracking-[-.02em] text-white">
                    Primrica Global Capital Investment Plans <span class="text-[#E31937]">•</span>
                </h2>
                <p class="mt-2 text-[13px] md:text-[14px] text-white/55 max-w-xl">
                    Choose from four Primrica Global Capital investment plans with fixed profit margins and clear
                    minimum and maximum investment limits.
                </p>
            </div>
            <div class="mt-2">
                <a href="{{ route('invest') }}"
                    class="inline-flex items-center gap-2 text-[13px] font-[800] text-[#E31937] hover:opacity-80 transition-colors">
                    View all plans
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
            ...
            <div
                class="rounded-[18px] border border-white/10 bg-white/5 px-5 py-5 flex flex-col justify-between hover:border-[#E31937]/40 hover:bg-white/[0.06] transition-colors">
                <div>
                    <div class="flex items-center justify-between gap-3 mb-2">
                        ...
                        <span
                            class="inline-flex items-center rounded-full bg-[#E31937]/15 px-3 py-1 text-[11px] font-[800] text-[#E31937]">
...
<section class="bg-white">
    <div class="wrap py-14">
        <div class="flex items-start justify-between gap-6">
            ...
            <a href="{{ route('inventory') }}"
                class="text-[13px] font-[700] text-[#E31937] hover:opacity-80 mt-2 transition-colors">
                View all
            </a>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-7">
            ...
            <div
                class="rounded-[18px] border border-black/10 bg-white overflow-hidden shadow-[0_10px_30px_rgba(0,0,0,0.08)] hover:shadow-[0_15px_40px_rgba(227,25,55,0.2)] transition">
                <!-- Image -->
...
<!-- Primrica Global Capital News Section -->
<section class="bg-white py-16">
    <div class="wrap">
        <div class="flex items-start justify-between gap-6 mb-8">
            <div>
                <h2 class="text-[32px] md:text-[40px] font-[900] tracking-[-.02em] text-[#0f1115]">
                    Primrica Global Capital News <span class="text-[#E31937]">•</span>
                </h2>
                <p class="mt-2 text-[15px] text-black/60">
                    Stay updated with the latest news, updates, and announcements from Primrica Global Capital.
                </p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div
                ...
                <div class="h-[200px] bg-[#f3f4f6] relative">
                    ...
                    <img src="{{ asset('images/news-1.jpg') }}" alt="Primrica Global Capital News"
                        class="w-full h-full object-cover" loading="lazy" />
                </div>
                <div class="p-5">
                    ...
                    <h3 class="text-[18px] font-[900] tracking-[-.01em] text-[#0f1115] mb-3">
                        Primrica Global Capital Announces Record-Breaking Q4 Deliveries
                    </h3>
                    <p class="text-[14px] text-black/60 leading-relaxed">
                        Primrica Global Capital delivered over 1.8 million vehicles in Q4 2025, marking another record
                        quarter and demonstrating strong global demand for electric vehicles.
                    </p>
                </div>
            </div>
            ...
            <div
                ...
                <div class="h-[200px] bg-[#f3f4f6] relative">
                    <div class="absolute top-3 left-3 w-2 h-2 rounded-full bg-[#E31937]"></div>
                    <img src="{{ asset('images/news-2.jpg') }}" alt="Primrica Global Capital News"
                        class="w-full h-full object-cover" loading="lazy" />
                </div>
                <div class="p-5">
                    ...
                    <p class="text-[14px] text-black/60 leading-relaxed">
                        Primrica Global Capital continues to expand its Supercharger network globally, adding 500 new
                        locations to make long-distance travel even more convenient for EV owners.
                    </p>
                </div>
            </div>
            ...
            <div
                ...
                <div class="h-[200px] bg-[#f3f4f6] relative">
                    <div class="absolute top-3 left-3 w-2 h-2 rounded-full bg-[#E31937]"></div>
                    <img src="{{ asset('images/news-3.jpg') }}" alt="Primrica Global Capital News"
                        class="w-full h-full object-cover" loading="lazy" />
                </div>
                <div class="p-5">
                    ...
                    <p class="text-[14px] text-black/60 leading-relaxed">
                        Primrica Global Capital's Full Self-Driving Beta v12.5 now available to over 500,000 users,
                        showcasing significant improvements in autonomous driving capabilities.
                    </p>
                </div>
            </div>
            ...
            <div
                ...
                <div class="h-[200px] bg-[#f3f4f6] relative">
                    <div class="absolute top-3 left-3 w-2 h-2 rounded-full bg-[#E31937]"></div>
                    <img src="{{ asset('images/news-4.jpg') }}" alt="Primrica Global Capital News"
                        class="w-full h-full object-cover" loading="lazy" />
                </div>
                <div class="p-5">
                    ...
                    <p class="text-[14px] text-black/60 leading-relaxed">
                        Primrica Global Capital's revolutionary Cybertruck production reaches new heights with increased
                        manufacturing capacity at Giga Texas facility.
                    </p>
                </div>
            </div>
            ...
            <div
                ...
                <div class="p-5">
                    ...
                    <p class="text-[14px] text-black/60 leading-relaxed">
                        Primrica Global Capital Energy announces major expansion of Megapack installations worldwide,
            ...
            <div
                ...
                <div class="p-5">
                    ...
                    <p class="text-[14px] text-black/60 leading-relaxed">
                        Primrica Global Capital Model Y maintains its position as the world's best-selling electric
                        vehicle, with over 1.2 million units delivered in 2025.
                    </p>
                </div>
            </div>
        </div>
...
<section id="stocks" class="bg-[#07090c] py-16 scroll-mt-20 border-t border-[#E31937]/20">
    <div class="wrap">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mt-8">
            <!-- Featured -->
            <div
                class="rounded-[18px] border border-white/10 bg-white/5 overflow-hidden hover:border-[#E31937]/50 transition-colors">
                <div
                    class="flex items-center justify-between px-5 py-4 text-[13px] font-[900] text-white/75 border-b border-[#E31937]/20">
                ...
                'TSLA' => 'Primrica Global Capital Inc.',
