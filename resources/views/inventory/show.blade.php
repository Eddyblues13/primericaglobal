...
@section('title', $car->name . ' - Primrica Global Capital Inventory')
    ...
    <div class="wrap">
        <div class="mb-6">
            <a href="{{ route('inventory') }}"
                class="inline-flex items-center gap-2 text-[13px] font-[700] text-[#E31937] hover:opacity-80 transition-colors mb-4">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div>
                <div class="car-image-slider">
                    ...
                    <img id="main-car-image" src="{{ asset($car->getAllImages()[0]) }}" alt="{{ $car->name }}"
                        class="active" />
                    ...
                    @endif
                    @else
                    <img src="{{ asset('images/Primrica Global Capital1.jpg') }}" alt="{{ $car->name }}" />
                    @endif
                </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-3 gap-4 mb-8 p-6 bg-[#f9fafb] rounded-[12px]">
                    ...
                    <div>
                        <div class="text-[20px] font-[900] text-[#0f1115]">{{ number_format($car->zero_to_sixty, 1) }}s
                        </div>
                ...
                <div class="flex gap-4">
                    ...
                    <form method="POST" action="{{ route('dashboard.orders.place') }}" class="flex-1">
                        ...
                        <button type="submit"
                            class="w-full h-[50px] rounded-md text-white text-[14px] font-[900] hover:opacity-90 transition cursor-pointer"
                    ...
                    @else
                    <a href="{{ route('login') }}"
                        class="flex-1 h-[50px] rounded-md text-white text-[14px] font-[900] hover:opacity-90 transition cursor-pointer inline-flex items-center justify-center"
                        style="background: #E31937;">
                        Login to Order
                    </a>
                    @endauth
