...
@section('title', 'Premium Tesla Vehicles for Sale | TESLA Market Hub Inventory')
@section('meta_title', 'Premium Tesla Vehicles for Sale | TESLA Market Hub Inventory')
@section('meta_description', 'Browse our collection of premium Tesla vehicles. Find your perfect Model S, Model 3, Model X, or Model Y. Reserve your electric vehicle today with flexible financing options.')
@section('meta_keywords', 'tesla for sale, tesla model s, tesla model 3, model x, model y, electric vehicles, ev inventory, tesla cars, buy tesla, tesla dealership')

@section('og_title', 'Tesla Premium Inventory - Electric Vehicles for Sale')
@section('og_description', 'Explore our curated selection of Tesla vehicles ready for delivery.  Model S, 3, X, and Y available now.')
