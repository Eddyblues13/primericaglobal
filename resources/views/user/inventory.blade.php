...
@section('title', 'Primrica Global Capital Inventory')
...
<div class="wrap" id="inventory">
    ...
    <div class="surface">
        <div class="heroCard">
            <div class="heroText">
                ...
                <p>Browse available Primrica Global Capital vehicles and place an order.</p>
            </div>
        </div>
    </div>
    ...
    @if (session('success'))
    <div
        style="padding: 12px; margin: 12px 0; border-radius: 10px; background: #d1fae5; border: 1px solid #86efac; font-size: 12px; color: #065f46;">
        {{ session('success') }}
    </div>
    @endif
    ...
    <div class="lowerGrid" style="grid-template-columns: 1fr; margin-top: 12px;">
        <div class="carGrid">
            ...
            <div class="carCard">
                ...
                $imageSrc = (str_starts_with($primaryImage ?? '', 'http')) ? $primaryImage : asset($primaryImage ??
                'images/Primrica Global Capital1.jpg');
                @endphp
                @if($primaryImage)
                <img src="{{ $imageSrc }}" alt="{{ $car->name }}" class="carImage"
                ...
                <div class="carBody">
                    ...
                    <div class="carFooter">
                        ...
                        <div class="carActions">
                            <button type="button" class="carButton secondary"
                                onclick="openCarModal({{ $car->id }})">View Details</button>
...
<script>
    ...
    function openCarModal(carId) {
        ...
        if (carImage) {
            ...
            html += `<img src="${imageSrc}" alt="${car.name}" class="carModalImage" onerror="this.src='/images/Primrica Global Capital1.jpg';">`;
        }
