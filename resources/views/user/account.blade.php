...
@section('title', 'Primrica Global Capital Account')
                ...
                <form method="POST" action="{{ route('dashboard.account.update') }}"
                    ...
                    <div class="accountSection">
                        ...
                        <div class="formGroup">
                            ...
                            <input type="text" name="name" value="{{ old('name', $user->name ?? '') }}" required
                                class="formInput" placeholder="Enter your full name" />
                        </div>

                        <div class="formGroup">
                            <label class="formLabel">Email Address</label>
                            <input type="email" name="email" value="{{ old('email', $user->email ?? '') }}" required
                                class="formInput" placeholder="Enter your email address" />
                        </div>
                    </div>
                    ...
                    <div class="accountSection">
                        ...
                        <div class="infoBox">
                            ...
                            password. All three fields are required only when changing your password.
                        </div>

                        <div class="formGroup">
                            <label class="formLabel">Current Password</label>
                            <div class="passwordWrapper">
                                <input type="password" name="current_password" id="current_password" class="formInput"
                                    placeholder="Enter your current password" />
                                <button type="button" class="passwordToggle"
                                    onclick="togglePassword('current_password', 'current_password_toggle')"
                                    id="current_password_toggle" aria-label="Toggle password visibility">
                        ...
                        <div class="formGroup">
                            ...
                            <div class="passwordWrapper">
                                ...
                                <button type="button" class="passwordToggle"
                                    onclick="togglePassword('password', 'password_toggle')" id="password_toggle"
                        ...
                        <div class="formGroup">
                            ...
                            <div class="passwordWrapper">
                                <input type="password" name="password_confirmation" id="password_confirmation"
                                    class="formInput" placeholder="Confirm your new password" />
                                <button type="button" class="passwordToggle"
                                    onclick="togglePassword('password_confirmation', 'password_confirmation_toggle')"
                                    id="password_confirmation_toggle" aria-label="Toggle password visibility">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z" />
                                        <circle cx="12" cy="12" r="3" />
                                    </svg>
