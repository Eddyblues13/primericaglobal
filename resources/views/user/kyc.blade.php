...
@section('title', 'Primrica Global Capital KYC Verification')
    ...
    <div class="surface">
        <div class="heroCard">
            <div class="heroText">
                ...
                <p>Complete your identity verification to access all platform features and unlock higher transaction
                    limits.</p>
            </div>
        </div>
    </div>
    ...
    <div class="lowerGrid" style="grid-template-columns: 1fr; margin-top: 12px;">
        <div class="whitePanel">
            ...
            <div style="padding: 20px;">
                @if ($errors->any())
                <div
                    style="padding: 12px; margin-bottom: 16px; border-radius: 10px; background: #fee2e2; border: 1px solid #fecaca;">
                ...
                @if (session('success'))
                <div
                    style="padding: 12px; margin-bottom: 16px; border-radius: 10px; background: #d1fae5; border: 1px solid #86efac; font-size: 12px; color: #065f46;">
                    {{ session('success') }}
                </div>
                @endif
                ...
                <form method="POST" action="{{ route('dashboard.kyc.submit') }}" enctype="multipart/form-data"
                    ...
                    <div class="formSection">
                        ...
                        <p class="sectionDescription">Upload a clear photo or scan of your Passport, Driver's License,
                            or National ID card. Both sides may be required.</p>

                        <div class="fileUploadArea" id="idDocumentArea"
                            onclick="document.getElementById('id_document').click()">
                            <input type="file" name="id_document" id="id_document" accept="image/*,.pdf" required
                                class="fileInput"
                                onchange="handleFileSelect(this, 'idDocumentArea', 'idDocumentPreview')" />
                            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#6b7280"
                                stroke-width="2" style="margin: 0 auto 8px;">
                                <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
                                <polyline points="17 8 12 3 7 8" />
                                <line x1="12" y1="3" x2="12" y2="15" />
                            </svg>
                            <p style="margin: 0; font-size: 12px; font-weight: 700; color: #6b7280;">Click to upload ID
                                document</p>
                            <p style="margin: 4px 0 0 0; font-size: 11px; color: #9ca3af;">JPG, PNG, or PDF (max 5MB)
                            </p>
                    ...
                    <div class="formSection">
                        ...
                        <p class="sectionDescription">Upload a utility bill, bank statement, or government document
                            showing your current address. Document must be less than 3 months old.</p>

                        <div class="fileUploadArea" id="addressArea"
                            onclick="document.getElementById('proof_of_address').click()">
                            <input type="file" name="proof_of_address" id="proof_of_address" accept="image/*,.pdf"
                                required class="fileInput"
                                onchange="handleFileSelect(this, 'addressArea', 'addressPreview')" />
                            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#6b7280"
                                stroke-width="2" style="margin: 0 auto 8px;">
                                <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
                                <polyline points="17 8 12 3 7 8" />
                            ...
                            <p style="margin: 0; font-size: 12px; font-weight: 700; color: #6b7280;">Click to upload
                                proof of address</p>
                            <p style="margin: 4px 0 0 0; font-size: 11px; color: #9ca3af;">JPG, PNG, or PDF (max 5MB)
                            </p>
                    ...
                    <div class="formSection">
                        ...
                        <p class="sectionDescription">Take a clear photo of yourself holding your ID document. Make sure
                            your face and the ID are clearly visible.</p>

                        <div class="fileUploadArea" id="selfieArea" onclick="document.getElementById('selfie').click()">
                            <input type="file" name="selfie" id="selfie" accept="image/*" required class="fileInput"
                                onchange="handleFileSelect(this, 'selfieArea', 'selfiePreview')" />
                            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#6b7280"
                                stroke-width="2" style="margin: 0 auto 8px;">
                                <path
                    ...
                    <div style="padding-top: 12px; border-top: 1px solid rgba(0,0,0,.06);">
                        <button type="submit"
                            style="height: 42px; padding: 0 24px; border-radius: 10px; background: #E31937; color: #fff; font-size: 12px; font-weight: 900; border: none; cursor: pointer; transition: all 0.2s; display: inline-flex; align-items: center; gap: 8px;">
