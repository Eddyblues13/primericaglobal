...
<p>We detected a new login to your TESLA account. If this was you, you can safely ignore this email. If you don't recognize this activity, please secure your account immediately.</p>
...
<div class="info-box" style="background: #f3f4f6; border-left: 4px solid #E31937; padding: 20px; margin: 24px 0;">
    ...
    <table style="width: 100%; border-collapse: collapse;">
        ...
        <tr>
            ...
            <td style="padding: 8px 0; color: #0f1115; font-weight: 500;">
                {{ $loginData['location']['city'] }}, {{ $loginData['location']['region'] }}, {{ $loginData['location']['country'] }}
            </td>
        </tr>
        <tr>
            <td style="padding: 8px 12px 8px 0; font-weight: 600; color: #6b7280;">
...
<div style="background: #fef2f2; border-left: 4px solid #ef4444; padding: 16px; margin: 24px 0; border-radius: 4px;">
    <p style="margin: 0; font-size: 14px; color: #991b1b;">
        ...
        <span style="color: #7f1d1d;">If you did not perform this login, your account may have been compromised. Please change your password immediately and contact our support team.</span>
    </p>
</div>

<a href="{{ route('dashboard.index') }}" class="button" style="display: inline-block; margin: 16px 0;">Go to Dashboard</a>

<div class="divider"></div>

<p style="font-size: 13px; color: #6b7280;">
    This is an automated security notification to help protect your account. We send these emails every time there's a login to your TESLA account.
</p>
