...
@section('title', 'Login - Primrica Global Capital')
            ...
            <div class="bg-white rounded-[18px] border border-black/10 p-8 shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
                    ...
                    <div class="flex items-center justify-between">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="remember"
                                class="w-4 h-4 rounded border-black/20 text-black focus:ring-2 focus:ring-black/20" />
                            <span class="text-[13px] text-black/60">Remember me</span>
                        </label>
                        <a href="{{ route('forgot-password') }}"
                            class="text-[13px] font-[700] text-black/60 hover:text-black transition">Forgot
                            password?</a>
                    </div>
                ...
                <p class="mt-6 text-center text-[13px] text-black/60">
                    Don't have an account? <a href="{{ route('register') }}"
                        class="font-[700] text-black hover:opacity-80 transition">Sign up</a>
                </p>
            </div>
        </div>
    </div>
