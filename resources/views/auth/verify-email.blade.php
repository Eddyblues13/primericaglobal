...
@section('title', 'Verify Email - Primrica Global Capital')
        ...
        <div class="max-w-md mx-auto">
            ...
            <div class="bg-white rounded-[18px] border border-black/10 p-8 shadow-[0_10px_30px_rgba(0,0,0,0.08)]">
                ...
                <form method="POST" action="{{ route('verify-email.post') }}" id="verification-form">
                    ...
                    <div class="mb-6">
                        <label class="block text-[13px] font-[700] text-black/60 mb-3 text-center">Enter Verification
                            Code</label>

                        <!-- 4-Digit Code Input -->
                        <div class="flex justify-center gap-3 mb-2">
                            <input type="text" maxlength="1"
                                class="code-input w-16 h-16 text-center text-[28px] font-[900] rounded-lg border-2 border-black/20 bg-white text-[#0f1115] focus:outline-none focus:ring-2 focus:ring-black focus:border-black transition"
                                data-index="0" />
                            <input type="text" maxlength="1"
                                class="code-input w-16 h-16 text-center text-[28px] font-[900] rounded-lg border-2 border-black/20 bg-white text-[#0f1115] focus:outline-none focus:ring-2 focus:ring-black focus:border-black transition"
                                data-index="1" />
                ...
                <div class="mt-6">
                    ...
                    <form method="POST" action="{{ route('resend-verification-code') }}">
                        @csrf
                        <button type="submit"
                            class="w-full h-[44px] rounded-md border border-black/15 bg-white text-[#0f1115] text-[13px] font-[900] hover:bg-black/5 transition">
                            Resend Code
                        </button>
                    </form>
                </div>
