...
@section('title', 'Live Stock Trading - Real-Time Market Data | Primrica Global Capital Market Hub')
@section('meta_title', 'Live Stock Trading - Real-Time Market Data | Primrica Global Capital Market Hub')
@section('meta_description', 'Trade stocks with real-time market data. Access top gainers, top losers, and most active
stocks. Start building your investment portfolio with live stock prices.')
@section('meta_keywords', 'stock trading, real-time stocks, stock market, top gainers, stock prices, trading platform,
investment portfolio, market data')

@section('og_title', 'Real-Time Stock Trading Platform | Primrica Global Capital Market Hub')
@section('og_description', 'Access live stock market data, track top gainers and losers, and trade with confidence.')
    ...
    <div class="wrap">
        <div class="max-w-3xl">
            ...
            <p class="text-[15px] md:text-[16px] text-white/60">
                Featured picks, top gainers, losers, and <span class="text-[#E31937] font-[600]">most active</span>
                stocks.
            </p>
        </div>
    </div>
            ...
            <div
                ...
                <div class="flex items-center justify-between gap-3 px-5 py-4 border-t border-white/7">
                    <div class="flex items-center gap-3 min-w-0">
                        <div
                            class="w-[30px] h-[30px] rounded-[10px] border border-[#E31937]/30 bg-black/20 grid place-items-center text-[#E31937] text-[12px] font-[900]">
                            {{ substr($symbol, 0, 1) }}
                        </div>
                        <div class="min-w-0">
            ...
            <div
                ...
                <div class="flex items-center justify-between px-5 py-4 border-t border-white/7">
                    <div class="flex items-center gap-3">
                        <div
                            class="w-[30px] h-[30px] rounded-[10px] border border-[#E31937]/30 bg-black/20 grid place-items-center">
                            <span class="text-[12px] font-[900] text-[#E31937]">{{ substr($stock['symbol'] ?? '?', 0, 2)
                                }}</span>
                        </div>
